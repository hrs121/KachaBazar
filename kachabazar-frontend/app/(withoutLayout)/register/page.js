...
export default function RegisterForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
      <div className="bg-gray-100 text-gray-700 rounded-3xl shadow-xl w-full max-w-4xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit}>
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="relative">
                        <MdAccountCircle className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg" />
                        <input
                        type="text"
                        name="firstName"
              ...
              <div className="px-3 mt-5">
                <button
                  type="submit"
                  className="block w-full bg-indigo-500 hover:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
                >
                  REGISTER NOW
                </button>
              </div>
